...
C LAST REVISED: 12/11/09 Blaise Barney
C ****************************************************************************
...
C     Print and show results 
      ...
      call prtdat(2)
C     Following routine needs fixed for Opteron compilers - not used currently
C     call draw_heat(%VAL(NXPROB),%VAL(NYPROB))
