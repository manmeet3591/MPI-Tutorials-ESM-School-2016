C *****************************************************************************
C TotalView Exercise 3 - MPI Example - Fortran Version
C FILE: tvEx3mpi.f
C DESCRIPTION:
...
C   NOTE: the number of MPI tasks must be equal to 4.
...
C ***** Initializations *****
      ...
      if (numtasks .ne. 4) then
        print *, 'Quitting. Number of tasks must be 4.'
