...
!-----------------------------------------------------------------------
   ...
   character(len=128) :: version='$Id: time_interp.f90,v 11.0.2.1 2004/10/04 18:35:12 gtn Exp $'
...
Time_between = real_to_time_type(real(time_type_to_real(Time) - time_type_to_real(Period) * nn))
